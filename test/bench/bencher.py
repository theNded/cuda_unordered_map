...
def analyze_singleton_experiment(input_file):
    with open(input_file) as json_file:
        ...
        for trial in trials:
            data_q0 = (trial["load_factor"], trial["build_rate_mps"],
                       trial["search_rate_mps"])

        print(
            "===============================================================================================")
        print("Singleton experiment:")
        print("\tNumber of elements to be inserted: %d" % (
        trials[0]['num_keys']))
        print("\tNumber of buckets: %d" % (trials[0]['num_buckets']))
        print("\tExpected chain length: %.2f" % (trials[0]['exp_chain_length']))
        print(
            "===============================================================================================")
        print("load factor\tbuild rate(M/s)\t\tsearch rate(M/s)")
        print(
            "===============================================================================================")
        print("%.2f\t\t%.3f\t\t%.3f" % (data_q0[0], data_q0[1], data_q0[2]))
...
def analyze_load_factor_experiment(input_file):
    with open(input_file) as json_file:
        ...
        print("\tNumber of elements to be inserted: %d" % (
        trials[0]['num_keys']))
        print("\t %.2f of %d queries exist in the data structure" % (
        trials[0]['query_ratio'], trials[0]['num_queries']))
        print(
            "===============================================================================================")
        print("load factor\tnum buckets\tbuild rate(M/s)\t\tsearch rate(M/s)")
        print(
            "===============================================================================================")
...
def analyze_table_size_experiment(input_file):
    with open(input_file) as json_file:
        ...
        print(
            "===============================================================================================")
        print(
            "(num keys, num buckets, load factor)\tbuild rate(M/s)\t\tsearch rate(M/s)")
        print(
            "===============================================================================================")
        for pair in tabular_data:
            print("(%d, %d, %.2f)\t\t\t%10.3f\t\t%.3f" % (
...
def analyze_concurrent_experiment(input_file):
    with open(input_file) as json_file:
        ...
        print(
                    "\tOperation ratio: (insert, delete, search) = (%.2f, %.2f, [%.2f, %.2f])" % (
            trials[0]['insert_ratio'], trials[0]['delete_ratio'],
            trials[0]['search_exist_ratio'],
            trials[0]['search_non_exist_ratio']))
        print(
            "===============================================================================================")
        print(
                    "batch_size = %d, init num batches = %d, final num batches = %d" % (
            trials[0]['batch_size'], trials[0]['num_init_batches'],
            trials[0]['num_batches']))
        print(
            "===============================================================================================")
        print(
...
def main(argv):
    input_file = ''
    try:
        opts, args = getopt.getopt(argv, "hvi:m:d:",
                                   ["help", "verbose", "ifile=", "mode=",
                                    "device="])
    except getopt.GetOptError:
        print(
            "bencher.py -i <inputfile> -m <experiment mode> -d <device index> -v")
        sys.exit(2)
    ...
    if mode == 0:
        ...
        print('bulk search mode deprecated')
    elif mode == 3:
